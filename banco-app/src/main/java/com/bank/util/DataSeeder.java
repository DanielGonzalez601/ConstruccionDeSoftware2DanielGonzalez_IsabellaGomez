...
public class DataSeeder {
    ...
    public void seedIfEmpty() {
        if (!userRepo.findAll().isEmpty()) {
            System.out.println("[SEED] Base de datos ya sembrada.");
            return;
        }
        System.out.println("[SEED] Sembrando datos iniciales...");
        ...
        System.out.println("[SEED] Datos iniciales sembrados exitosamente!");
        System.out.println("[SEED] ================================");
        System.out.println("[SEED] CREDENCIALES DE PRUEBA:");
