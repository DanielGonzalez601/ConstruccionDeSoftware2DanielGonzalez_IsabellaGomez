...
public class DatabaseManager {
    ...
    public Connection getConnection() {
        try {
            ...
            throw new RuntimeException("No se pudo obtener la conexión a la base de datos: " + e.getMessage(), e);
        }
        return connection;
    }
    ...
    private void createTables() throws SQLException {
        ...
        stmt.close();
        System.out.println("[DB] Las tablas de la base de datos se inicializaron correctamente.");
    }
}
