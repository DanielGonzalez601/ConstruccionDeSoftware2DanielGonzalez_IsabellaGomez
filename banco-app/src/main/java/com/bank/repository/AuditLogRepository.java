...
public class AuditLogRepository implements DomainEventPublisher {
    ...
    public List<AuditLog> findAll() {
        try {
            ...
            return list;
        } catch (SQLException e) { throw new RuntimeException("Error al enumerar los registros de auditoría", e); }
    }
    ...
    public List<AuditLog> findByProductId(String productId) {
        try {
            ...
            while (rs.next()) list.add(mapRow(rs));
            return list;
        } catch (SQLException e) { throw new RuntimeException("Error al encontrar registros de auditoría", e); }
    }
    ...
    public List<AuditLog> findByUserId(int userId) {
        try {
            ...
            while (rs.next()) list.add(mapRow(rs));
            return list;
        } catch (SQLException e) { throw new RuntimeException("Error al encontrar registros de auditoría por usuario", e); }
    }
