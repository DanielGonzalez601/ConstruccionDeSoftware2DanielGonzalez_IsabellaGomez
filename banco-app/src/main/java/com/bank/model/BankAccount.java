...
public class BankAccount {
    ...
    public static BankAccount open(String accountNumber, String ownerId,
        ...
        if (accountNumber == null || accountNumber.isBlank())
            throw new DomainException("Se requiere número de cuenta.");
        if (ownerId == null || ownerId.isBlank())
            throw new DomainException("Se requiere ID del propietario.");
        if (accountType == null)
            throw new DomainException("Se requiere tipo de cuenta.");
    ...
    public void withdraw(Money amount) {
        ...
        if (this.balance.isLessThan(amount))
            throw new DomainException("Fondos insuficientes. Disponible: " + balance + ", solicitado: " + amount);
        Money before = this.balance;
    ...
    public void block(String reason) {
        if (this.status == AccountStatus.CANCELLED)
            throw new DomainException("No se puede bloquear una cuenta cancelada.");
    ...
    public void activate() {
        if (this.status == AccountStatus.CANCELLED)
            throw new DomainException("No se puede activar una cuenta cancelada.");
    ...
    private void validateActive() {
        if (this.status != AccountStatus.ACTIVE)
            throw new DomainException("Cuenta " + accountNumber + " está " + status + ". No se pueden realizar operaciones.");
    }
