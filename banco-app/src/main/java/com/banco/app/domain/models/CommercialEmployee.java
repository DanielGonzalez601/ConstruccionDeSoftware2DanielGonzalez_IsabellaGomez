...
public class CommercialEmployee extends User {
    ...
    public CommercialEmployee(String userId, String relationId, String fullName, String identificationNumber,
        ...
        super(userId, relationId, fullName, identificationNumber, email, phone,
              birthDate, address, UserRoles.COMMERCIAL_EMPLOYEE, username, passwordHash);
    }

    @Override
    public String toString() {
        return "CommercialEmployee{userId='" + getUserId() +
